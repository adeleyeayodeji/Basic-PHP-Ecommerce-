	...
	<div class="content-blog">
		...
		<?php if(isset($smsg)){ ?><div class="alert alert-success" role="alert"> <?php echo $smsg; ?> </div><?php } ?>
			...
			<form method="post" enctype="multipart/form-data">
			  ...
			  <input type="hidden" name="filepath" value="<?php echo $r['productimage1']; ?>">
			  ...
			  <div class="form-group">
			    ...
			    <?php if(isset($r['productimage1']) & !empty($r['productimage1'])){ ?>
			    <br>
			    	<img src="<?php echo $r['productimage1'] ?>" widht="100px" height="100px">
